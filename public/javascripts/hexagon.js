...
HexagonGrid.prototype.drawHex = function (x0, y0, fillColor, debugText) {
    ...
    this.context.fillStyle = "#9ab4cf";
    this.context.globalAlpha = 0.6;
    this.context.fill();

    var img = new Image();

    if (fillColor == "duplicate") {
        img.src = "/assets/images/hexnear.png";
    }

    if (fillColor == "jump") {
        img.src = "/assets/images/hexwide.png";
    }

    this.context.globalAlpha = 1;

    if (fillColor == 'p1') {
        img.src = "/assets/images/hexpurple.png";
    }

    if (fillColor == "p2") {
        img.src = "/assets/images/hexgree.png";
    }
    ...
    img.onload = function () {
        ...
        this.context.drawImage(img, x0, y0, 80, 70);
    }
...
HexagonGrid.prototype.clickEvent = function (e) {
    ...
    this.refresh(tile.column, tile.row);
};

HexagonGrid.prototype.refresh = function (x, y) {
